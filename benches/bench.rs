...
fn profile_distr<D: Distribution>(distr: D, map_size: usize, c: &mut Criterion) {
    ...
    profile_hashonly::<fnv::FnvBuildHasher, _>("fnv", distr.clone(), c);
    profile_hashonly::<rustc_hash::FxBuildHasher, _>("rustc-hash", distr.clone(), c);
    ...
    profile_lookup_miss::<fnv::FnvBuildHasher, _>("fnv", distr.clone(), map_size, c);
    profile_lookup_miss::<rustc_hash::FxBuildHasher, _>("rustc-hash", distr.clone(), map_size, c);
    ...
    profile_lookup_hit::<fnv::FnvBuildHasher, _>("fnv", distr.clone(), map_size, c);
    profile_lookup_hit::<rustc_hash::FxBuildHasher, _>("rustc-hash", distr.clone(), map_size, c);
    ...
    profile_set_build::<fnv::FnvBuildHasher, _>("fnv", distr.clone(), map_size, c);
    profile_set_build::<rustc_hash::FxBuildHasher, _>("rustc-hash", distr.clone(), map_size, c);
